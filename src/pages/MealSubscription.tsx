      ...
      <div className="container relative py-16 md:py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 max-w-lg text-lg text-inverse-foreground">
            Meal subscription enrollment is currently paused while billing and rotating-menu fulfillment are verified.
          </p>
        </div>
      </div>
    </div>
        ...
        <Card className="mx-auto max-w-2xl border-accent/30 bg-card shadow-lg">
          <CardContent className="p-8 text-center md:p-10">
            ...
            <p className="mt-3 text-muted-foreground">
              New meal subscriptions are paused until the rotating-menu billing and fulfillment rules are fully configured and verified.
            </p>
